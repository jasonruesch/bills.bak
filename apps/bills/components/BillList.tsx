        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="mt-2 flex flex-col">
            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
              <div className="flex flex-col items-center justify-between space-y-3 border-b border-gray-200 bg-white p-4 text-gray-900 md:flex-row md:space-y-0 md:space-x-4">
                <form className="flex w-full items-center justify-between whitespace-nowrap">
                  <fieldset>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead>
                    <tr>
                      ...
                      <th
                        className="w-[52px] whitespace-nowrap bg-gray-50 px-6 py-3 text-right text-sm font-semibold text-gray-900"
                        scope="col"
                      >
